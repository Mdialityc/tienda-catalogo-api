...
public class GenerateSessionTokenEndpoint(AppDbContext dbContext)
    : EndpointWithoutRequest<Results<Ok<string>, ProblemDetails>>
{
    ...
    public override async Task<Results<Ok<string>, ProblemDetails>> ExecuteAsync(CancellationToken ct)
    {
